...
- **ประวัติ metrics** — ทุกค่าถูกสุ่มเก็บลง SQLite ท้องถิ่นทุก 10 วินาที
  ...
  (CPU/GPU/ดิสก์) และความเร็วพัดลม (CPU RPM / GPU %) มีปุ่มสลับซีรีส์และแกน Y หลายแกน
...
# รันแดชบอร์ดในโหมด Administrator เพื่อให้อ่านเซนเซอร์ได้
.\run.ps1   # จากหน้าต่าง PowerShell ที่ยกระดับ (elevated)
```
...
- ซีรีส์: CPU/RAM/swap %, อุณหภูมิสูงสุด CPU/GPU/ดิสก์, ความเร็วพัดลม CPU RPM,
  GPU fan %, ทราฟฟิกเครือข่ายและดิสก์ (MB/s)
...
การฆ่าโปรเซสที่มีสิทธิ์) ให้เปิดเทอร์มินัลใหม่ **ในโหมด Administrator** แล้วรัน
`.\run.ps1` จากนั้น
